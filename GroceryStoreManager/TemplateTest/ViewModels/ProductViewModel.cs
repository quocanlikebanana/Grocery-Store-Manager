...
public partial class ProductViewModel : ObservableRecipient, INavigationAware
{
    ...
    public ProductViewModel(INavigationService navigationService, ISampleDataService sampleDataService)
    {
    ...
    private void OnItemClick(SampleOrder? clickedItem)
    {
        if (clickedItem != null)
        {
            ...
            _navigationService.NavigateTo(typeof(ProductDetailViewModel).FullName!, clickedItem.OrderID);
        }
    }
}
